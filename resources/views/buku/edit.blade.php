	...
	<div class="container">
		...
		<div class="card shadow">
			...
			<div class="card-body">
                ...
                @csrf
                @method('PUT')
						<input type="hidden" name="id" value="{{old('id', $buku->id)}}">
						<div class="row">
							<div class="col-sm-3" style="margin-bottom: 30px;">Judul Buku</div>
							<div class="col-sm-8"><input type="text" name="judul" value="{{old('judul', $buku->judul)}}" class="form-control"></div>
						</div>
						<div class="row">
							<div class="col-sm-3" style="margin-bottom: 30px;">Penulis Buku</div>
							<div class="col-sm-8"><input type="text" name="penulis" value="{{old('penulis', $buku->penulis)}}" class="form-control"></div>
						</div>
						<div class="row">
							<div class="col-sm-3" style="margin-bottom: 30px;">Tahun Terbit</div>
							<div class="col-sm-8"><input type="text" name="tahun" value="{{old('tahun', $buku->tahun)}}" class="form-control"></div>
						</div>
						<div class="row">
