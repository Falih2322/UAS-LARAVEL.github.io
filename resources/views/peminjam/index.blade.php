	...
	<div class="container">
		...
		<div class="card shadow">
			...
			<div class="card-body">
				...
				style="margin-bottom: 20px">TAMBAH PEMINJAM</button>
				<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
					<div class="modal-dialog">
						<div class="modal-content">
							<div class="modal-header">
								<h5 class="modal-title" id="exampleModalLabel">Input Data Peminjam</h5>
							...
							<div class="modal-body">
								...
								@csrf
									<div class="row">
										...
										<div class="col-sm-8"><input type="text" name="namapeminjam" class="form-control" required></div>
									</div>
                                    <div class="row">
										<div class="col-sm-3" style="margin-bottom: 30px;">Buku yang dipinjam</div>
										<div class="col-sm-8"><input type="text" name="bukuyangdipinjam" class="form-control" required></div>
									</div>
									<div class="row">
									...
									<div class="row">
										...
										<div class="col-sm-8"><input type="text" name="tanggalpengembalian" class="form-control" required></div>
									</div>
									<div class="row">
					...
					<table class="table table-hover" width="99%" cellspacing="0"  id="example" class="display">
                        ...
                        <?php 
							...
							foreach($data as $value){ 
								...
								$bukuyangdipinjam = $value->bukuyangdipinjam;
								$alamat = $value->alamat;
								$telepon = $value->telepon;
								$tanggalpengembalian = $value->tanggalpengembalian;
								$count++;
								?>
								<tr>
									<td><?php echo $count; ?></td>
									<td><?php echo $namapeminjam; ?></td>
									<td><?php echo $bukuyangdipinjam; ?></td>
									<td><?php echo $alamat; ?></td>
									<td><?php echo $telepon; ?></td>
									<td><?php echo $tanggalpengembalian; ?></td>
									<td>
										<form action="{{ route('peminjam.destroy', $value->id) }}" method="POST">
											@csrf
											@method('delete')
											<button type="submit" class="btn btn-danger btn-sm shadow" href="">Delete</button>
											<a class="btn btn-info btn-sm shadow" href="{{ route('peminjam.edit', $value->id) }}">Edit</a>
										</form>
									</td>
								</tr>
							<?php }; ?>
